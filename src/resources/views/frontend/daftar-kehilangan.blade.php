...
<body class="contact-page">
  ...
  <main class="main">
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/apa.png);">
      <div class="container position-relative">
        ...
        <p>Berikut adalah daftar barang-barang yang dilaporkan hilang. Periksa apakah Anda menemukan barang milik seseorang di sini.</p>
  ...
  <section id="daftar-kehilangan" class="contact section">
    <div class="container" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <h3 class="text-center mb-4">Daftar Barang Kehilangan</h3>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              @empty
              <tr>
                <td colspan="6" class="text-center">Belum ada laporan kehilangan.</td>
              </tr>
              @endforelse
            </tbody>
          </table>
