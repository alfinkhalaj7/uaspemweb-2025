...
<body class="contact-page">
  ...
  <section id="daftar-penemuan" class="contact section">
    <div class="container" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <h3 class="text-center mb-4">Daftar Barang Penemuan</h3>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              @empty
              <tr>
                <td colspan="6" class="text-center">Belum ada laporan penemuan barang.</td>
              </tr>
              @endforelse
            </tbody>
          </table>
