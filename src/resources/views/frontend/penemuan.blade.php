...
<head>
  ...
  <title>PENEMUAN - TemuBarang Bootstrap Template</title>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-8 mx-auto">
            <div class="card shadow p-4">
              <h4 class="mb-3 text-center">Formulir Laporan Penemuan</h4>

              <!-- PERINGATAN -->
              <div class="alert alert-warning text-center" role="alert">
                Jika Anda menemukan barang, mohon segera bawa ke <strong>Ruang Temu Barang</strong> setelah mengisi formulir ini.
              </div>

              <form action="{{ route('penemuan.submit') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                  <label for="lokasi" class="form-label">Lokasi Penemuan</label>
                ...
                <div class="d-grid">
                  <button type="submit" class="btn btn-primary">Laporkan Penemuan</button>
                </div>
              </form>

              <!-- Tambahan penegasan setelah form -->
              <p class="mt-4 text-muted text-center" style="font-size: 0.9rem;">
                Setelah mengisi formulir, harap segera menuju <strong>Ruang Temu Barang</strong> untuk menyerahkan barang yang ditemukan.
              </p>
            </div>
          </div>
        </div>
